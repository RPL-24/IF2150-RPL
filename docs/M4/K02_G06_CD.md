...
| ID Kelas | Nama Kelas | Deskripsi Kelas |
| :--- | :--- | :--- |
| *C03* | *Pembeli* | *Mengirimkan batasan pencarian* |
| *C04* | *listingMakanan* | *Menyaring dan menampilkan hasil listing yang sudah disaring* |
...
| ID Kelas | Nama Kelas | Atribut | Metode/Operasi |
| :--- | :--- | :--- | :--- |
| *C03* | *Pembeli* | *idPembeli, nama* | *cariListing(), saringListing()* |
| *C04* | *ListingMakanan* | *idListing, namaMakanan, harga, stok, deskripsi* | *saringKataKunci(), saringRentangHarga()* |
...
| ID Kelas | Nama Kelas | Deskripsi Kelas |
| :--- | :--- | :--- |
| *C03* | *Pembeli* | *Menyimpan data akun pelanggan yang membuat pesanan.* |
| *C04* | *listingMakanan* | *Mengurangi pesanan yang dipilih dari sistem* |
| *C05* | *Pembayaran* | *Menampilkan QRIS dummy dan mensimulasikan proses pembayaran* |
| *C06* | *Transaksi* | *Menghitung total dan menyimpan data transaksi yang dilakukan* |
