...
| *C06* | *RewardLogin* | *Mengelola poin quest harian yang didapatkan pembeli dari aktivitas login harian serta melacak status klaim reward milik pembeli.* | *UC07, UC08* |
