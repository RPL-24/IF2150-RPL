...
| :--- | :--- | :--- |
| 1 | *Penjual memilih tombol "tambahkan makanan"* | *Sistem menampilkan halaman untuk mengunggah foto makanan serta menyediakan kolom terstruktur dan kolom bebas untuk mengisi deskripsi makanan* |
| 2 | *Penjual mengonfirmasi penambahan makanan* | *Sistem mengecek menerima respons penambahan berhasil, memperbarui listing makanan penjual, dan menampilkan notifikasi penambahan makanan berhasil* |
