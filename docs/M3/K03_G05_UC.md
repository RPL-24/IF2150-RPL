...
| :--- | :--- | :--- | :--- | :--- |
| UC01 | Melakukan Login bagi Masyarakat | Masyarakat melakukan login/registrasi akun untuk mengakses semua fitur LawHub. | Masyarakat | KF01, KF02 |
| UC02 | Melakukan Login bagi Mitra Pengacara | Mitra pengacara dapat melakukan registrasi akun dengan mengunggah file yang diperlukan atau login dengan akun yang sudah diverifikasi. | Mitra pengacara | KF03 |
| UC03 | Melihat Status Registrasi Akun Mitra Pengacara | Mitra pengacara dapat melihat status registrasi akun yang baru dibuat. | Mitra pengacara | KF04 |
| UC04 | Memverifikasi Pendaftar Mitra Pengacara | Admin memeriksa dokumen dan menentukan legalitas mitra pengacara. | Admin | KF05 |
| UC05 | Verifikasi Akun Pengacara | Mitra pengacara mengunggah dokumen legalitas dan mengisi/mengedit identitas firma. | Mitra pengacara | KF06, KF07 |
| UC06 | Melakukan Pencarian Pasal | Masyarakat mencari pasal yang berkaitan dengan kasus yang sedang dialami menggunakan minimal satu kata kunci. | Masyarakat | KF08 |
| UC07 | Melihat Daftar Pengacara | Masyarakat mencari mitra pengacara sesuai masalah yang dihadapi dengan menggunakan filter. | Masyarakat | KF09 |
| UC08 | Memilih Mitra Pengacara untuk Sesi Konsultasi | Masyarakat memilih jadwal tersedia untuk sesi konsultasi dengan mitra pengacara yang dipilih.  | Masyarakat | KF09 |
| UC09 | Menanggapi Sesi Konsultasi | Mitra pengacara menerima dan melakukan konsultasi untuk masyarakat. | Mitra pengacara | KF10 |
| UC10 | Melakukan Sesi Konsultasi | Masyarakat melakukan sesi konsultasi dengan mitra pengacara via *chat*. | Masyarakat dan Mitra Pengacara | KF11 |
| UC11 | Memberi Ulasan, Feedback, dan/atau Rating | Masyarakat mengirim teks dan/atau foto sebagai bentuk ulasan, *feedback*, dan/saran setelah melakukan sesi konsultasi. | Masyarakat | KF12 |
| UC12 | Melaporkan Pelanggaran | Masyarakat melaporkan akun mitra pengacara yang melakukan pelanggaran saat/setelah sesi konsultasi berlangsung. | Masyarakat | KF13 |
| UC13 | Melaporkan Pelanggaran | Mitra pengacara melaporkan akun masyarakat yang melakukan pelanggaran saat/setelah sesi konsultasi berlangsung. | Mitra Pengacara | KF13 |
| UC14 | Melaporkan Ulasan | Mitra pengacara melaporkan ulasan yang tidak relevan. | Mitra Pengacara | KF14 |
| UC15 | Memblokir Akun | Admin melakukan ban kepada akun yang melanggar kebijakan sistem. | Admin | KF15, KF16 |
| UC16 | Melihat Riwayat Penanganan | Mitra pengacara melihat riwayat kasus yang telah ditangani secara keseluruhan. | Mitra Pengacara | KF17 |
| UC17 | Menanyakan Masalah Teknis | Masyarakat bertanya kepada admin melalui fitur *live chat*. | Masyarakat dan Admin | KF18 |
| UC18 | Menjawab Pertanyaan | Admin menjawab pertanyaan masyarakat melalui *live chat*. | Admin | KF18 |
| UC19 | Membayar Biaya Sesi Konsultasi | Masyarakat melakukan transaksi pembayaran sesuai dengan pilihan metode pembayaran digital. | Masyarakat | KF19 |
| UC20 | Mencairkan Dana | Mitra pengacara mendapatkan pencairan dana ke rekening yang telah didaftarkan di profil akun. | Masyarakat | KF19 |
