...
| No | Aksi Aktor | Reaksi Perangkat Lunak |
| :--- | :--- | :--- |
| 1 | *Pengguna melakukan input data (email, password sesuai syarat)* | *Sistem berhasil memvalidasi email dan password, melakukan password hashing, membuat unique ID, serta mencantumkannya ke database. Sistem menampilkan "Akun berhasil didaftarkan* |

**Skenario Alternatif 1: Email Pengguna Tidak Valid**

| No | Aksi Aktor | Reaksi Perangkat Lunak |
| :--- | :--- | :--- |
| 1 | *Pengguna melakukan input data (email tidak sesuai, password sesuai syarat)* | *Sistem menampilkan "Alamat email tidak valid" dan meminta pengguna memasukkan ulang* |

**Skenario Alternatif 2: Password Pengguna Tidak Memenuhi Syarat**

| No | Aksi Aktor | Reaksi Perangkat Lunak |
| :--- | :--- | :--- |
| 1 | *Pengguna melakukan input data (email, password tidak sesuai syarat)* | *Sistem menampilkan "Password tidak sesuai syarat" dan meminta pengguna memasukkan ulang* |

### 3.4.2 Skenario UC02

**Nama Use Case:** *Mengcustomize preferensi pada profil*

**Skenario Normal**

| No | Aksi Aktor | Reaksi Perangkat Lunak |
| :--- | :--- | :--- |
| 1 | *Pengguna mengganti preferensi pada profil* | *Sistem menyimpan draft perubahan preferensi pada tampilan pengguna* |
| 2 | *Pengguna menekan tombol simpan perubahan* | *Sistem menyimpan draft perubahan secara permanen* |

<br>

**Skenario Alternatif 1: Sistem Tidak Bisa Terkoneksi Ke Database**

| No | Aksi Aktor | Reaksi Perangkat Lunak |
| :--- | :--- | :--- |
| 1 | *Pengguna mengganti preferensi pada profil* | *Sistem menyimpan draft perubahan preferensi* |
| 2 | *Pengguna menekan tombol simpan perubahan* | *Sistem Menampilkan "Perubahan Gagal Disimpan" dan meminta pengguna mencoba kembali* |
