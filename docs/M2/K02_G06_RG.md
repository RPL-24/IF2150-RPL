...
| *R02* | *A02* | *System* | *Ketika penjual menambahkan atau mengedit listing, sistem akan mengupdate listing secara real-time* | *Ya* |
| *R03* | *A06* | *User* | *Ketika membuka website, pembeli dapat melihat daftar dan detail makanan berlebih (foto, stok, harga) yang tersedia dari berbagai penjual* | *Ya* |
| *R04* | *A05* | *System* | *Sistem mengimplementasikan fitur penyaringan yang memungkinkan pengguna mencari barang dengan ketentuan tertentu, kemudian sistem menyaring listing yang ada, lalu ditampilkan sesuai penyaringan yang diminta user* | *Ya* |
| *R05* | *A07* | *System* | *Ketika melakukan pembelian, sistem mengurangi jumlah stok, menghitung total harga, menampilkan QRIS dummy untuk pembayaran, dan memberikan kode unik pembyaran* | *Ya* |
| *R02* | *A02* | *System* | *Ketika penjual menambahkan atau mengedit listing, sistem akan mengupdate listing secara real-time* | *Ya* |
| *R03* | *A06* | *User* | *Ketika membuka website, pembeli dapat melihat daftar dan detail makanan berlebih (foto, stok, harga) yang tersedia dari berbagai penjual* | *Ya* |
| *R04* | *A05* | *System* | *Sistem mengimplementasikan fitur penyaringan yang memungkinkan pengguna mencari barang dengan ketentuan tertentu, kemudian sistem menyaring listing yang ada, lalu ditampilkan sesuai penyaringan yang diminta user* | *Ya* |
| *R05* | *A07* | *System* | *Ketika melakukan pembelian, sistem mengurangi jumlah stok, menghitung total harga, menampilkan QRIS dummy untuk pembayaran, dan memberikan kode unik pembyaran* | *Ya* |
...
| *R07* | *A02, A03* | *User* | *Ketika penjual memilih untuk mengedit atau menghapus suatu listing yang sudah diunggah, sistem harus menyimpan perubahan tersebut dan memperbarui tampilan listing yang dilihat pembeli* | *Ya* |
| *R08* | *A04* | *Business* | *Makanan yang didata sebagai "makanan surplus" harus merupakan makanan yang tidak habis terjual namun masih dalam kondisi layak konsumsi, sesuai batasan sistem yang tidak melakukan pengecekan ulang kelayakan makanan* | *Tidak* |
| *R09* | *A07* | *Business* | *Ketika pembeli hendak mengambil makanan yang telah dipesan dan dibayar, pengambilan hanya dapat dilakukan langsung di kantin/toko penjual karena platform tidak menyediakan layanan pengantaran* | *Tidak* |
| *R10* | *A08* | *User* | *Ketika pembeli login ke sistem pada suatu hari, selama pembeli belum login pada hari tersebut, sistem harus mencatat login dan menambahkan poin quest harian ke progres reward pembeli* | *Ya* |
| *R11* | *A08* | *Business* | *Ketika pembeli menukarkan poin reward yang dimiliki, sistem harus memproses penukaran tersebut sebagai potongan harga makanan, bukan dalam bentuk uang tunai* | *Ya* |
| *R12* | *A07* | *Business* | *Ketika suatu transaksi pembelian berhasil diselesaikan, sistem harus menghitung dan memotong biaya layanan (komisi) dari nilai transaksi tersebut kepada penjual* | *Ya* |
| *R13* | *A01* | *Business* | *Foto makanan yang diunggah penjual harus merupakan foto asli kondisi makanan yang bersangkutan, bukan gambar ilustrasi, guna menghindari informasi yang menyesatkan pembeli* | *Tidak* |
| *R14* | *A01--A08* | *System* | *Ketika terjadi sebuah kesalahan, maka sistem akan menampilkan pesan error sesuai dengan kesalahan yang terjadi* | *Tidak* |
...
| :--- | :--- | :--- | :--- |
| *KNF01* | *R02* | *Availability* | *Ketika pengguna terhubung ke sistem, sistem harus dapat menampilkan data secara real-time atau near real-time segera setelah terjadi perubahan pada database.* |
