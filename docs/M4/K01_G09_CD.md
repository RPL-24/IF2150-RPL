...
| *C09* | *Preference* | *Kelas yang menyimpan pengaturan pengguna, seperti tag mata pelajaran, ketersediaan schedule pada kalender, dan preferensi metode belajar (luring/daring) agar digunakan oleh algoritma matchmaking.* | *UC02, UC04* |
| *C10* | *Profile* | *Kelas yang merepresentasikan data identitas pengguna (nama, university, program studi, bio) yang dihubungkan dengan akun User.* | *UC01, UC02* |
| *C11* | *Dashboard* | *Kelas antarmuka utama yang menampilkan rangkuman schedule sesi terdekat, notifikasi, dan rekomendasi matchmaking untuk Mentee.* | *UC01, UC04, UC06, UC09* |
| *C12* | *UserDatabase* | *Kelas pengontrol yang bertanggung jawab memvalidasi email university, mengelola autentikasi login, serta menyimpan data akun ke dalam sistem.* | *UC01, UC02* |
| *C13* | *SessionDatabase* | *Kelas pengontrol yang bertanggung jawab menyimpan, memperbarui, memvalidasi tabrakan schedule, serta mengambil data Session, Feedback, dan SessionHistory dari sistem.* | *UC03, UC04, UC05, UC06, UC10, UC11, UC12* |
...
| *C11* | *Dashboard* | *Kelas antarmuka utama yang menampilkan rangkuman schedule sesi terdekat dan notifikasi setelah pengguna masuk.* |
| *C12* | *UserDatabase* | *Kelas pengontrol yang bertanggung jawab memvalidasi email university, mengelola autentikasi login, serta menyimpan data akun ke dalam sistem.* |
...
| :--- | :--- | :--- | :--- |
| *C01* | *User* | *userID, email, passwordHash* | *register(), login(), logout()* |
| *C02* | *Mentor* | *sessionListDibuat* | *inherit dari User* |
| *C03* | *Mentee* | *attendedSessions* | *Inherit dari User* |
| *C10* | *Profile* | *nama, university, studyProgram, bio* | *updateProfile()* |
| *C11* | *Dashboard* | *scheduleUser, notifikasi* | *showDashboard()* |
| *C12* | *UserDatabase* | *accountList* | *emailValidation(), loginAuth(), saveAccount()* |
...
| *C02* | *Mentor* | *sessionListDibuat* | *inherit dari User* |
| *C03* | *Mentee* | *attendedSessions* | *inherit dari User* |
| *C09* | *Preference* | *materialTag, avaiability, preferensiFormatSesi* | *updatePreference()* |
| *C10* | *Profile* | *nama, university, studyProgram, bio* | *updateProfile()* |
...
| ID Kelas | Nama Kelas | Atribut | Metode/Operasi |
| :--- | :--- | :--- | :--- |
| *C02* | *Mentor* | *sessionListDibuat* | *createSession()* |
| *C04* | *Session* | *sessionID, topic, schedule, format, capacity, daftarPeserta, status* | *createSession(), setCapacity()* |
...
| *C04* | *Session* | *sessionID, topic, schedule, format, capacity, daftarPeserta, status* | *addParticipant(), checkCapacity()* |
| *C09* | *Preference* | *materialTag, avaiability, preferensiFormatSesi* | *showPreference()* |
...
| *C09* | *Preference* | *materialTag, avaiability, preferensiFormatSesi* | *getSessionDetails(idSesi : String)* |
| *C11* | *Dashboard* | *sessionRecommendation* | *showRecommendation()* |
| *C13* | *SessionDatabase* | *sessionList* | *findRecommendation(), saveSession()* |
