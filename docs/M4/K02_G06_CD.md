...
| *C04* | *Pembayaran* | *Kelas abstrak yang merepresentasikan metode pembayaran yang dipilih pelanggan yang direalisasikan dengan QRIS dummy* | *UC05* |
...
| *C03* | *listingMakanan* | *Menyimpan data pesanan yang dibuat dari isi keranjang.* |
| *C04* | *Pembayaran* | *Menyimpan data akun pelanggan yang membuat pesanan.* |
| *C05* | *Transaksi* | *Menyimpan data pesanan yang dibuat dari isi keranjang.* |
