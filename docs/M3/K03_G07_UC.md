...
| 3 | *Warga memilih kategori kerusakan, mengisi deskripsi, dan mengunggah foto kerusakan* | - | - | - |
| 4 | - | - | - | *Sistem memvalidasi format (JPG/PNG) dan ukuran foto (maksimal 10 MB), lalu menampilkan pratinjau foto dan titik lokasi pada peta* |
...
| 1 | *Warga memilih menu "Buat Laporan"* | - | - | - |
| 2 | - | - | - | *Sistem menampilkan formulir pelaporan dan secara otomatis mendeteksi serta mengunci koordinat GPS perangkat* |
| 3 | *Warga memilih kategori kerusakan, mengisi deskripsi, dan mengunggah foto berformat selain JPG/PNG atau berukuran lebih dari 10 MB* | - | - | - |
| 4 | - | - | - | *Sistem menolak berkas, menampilkan pesan peringatan validasi berupa format dan ukuran yang diterima, dan tidak menyimpan foto tersebut* |
| 5 | *Warga mengunggah foto lain yang valid* | - | - | - |
...
| :--- | :--- | :--- | :--- | :--- |
| 1 | *Warga memilih menu "Buat Laporan"* | - | - | - |
| 2 | - | - | - | *Sistem gagal memperoleh koordinat dari layanan geolokasi perangkat karena izin lokasi ditolak atau sinyal tidak tersedia, menampilkan pesan bahwa lokasi wajib terdeteksi, dan menonaktifkan tombol "Kirim"* |
| 3 | *Warga mengaktifkan izin lokasi pada perangkat lalu menekan tombol "Coba Lagi"* | - | - | - |
| 4 | - | - | - | *Sistem mengulang deteksi lokasi. Jika berhasil, sistem kembali ke langkah 1 skenario normal* |
...
| 4 | - | - | - | *Sistem menampilkan rincian laporan berupa foto bukti, deskripsi keluhan, kategori, waktu masuk, peta lokasi, dan jumlah upvote* |
...
| 2 | - | - | - | *Sistem menampilkan antrean laporan berstatus "Diterima" yang terurut berdasarkan waktu masuk, dilengkapi kontrol filter kategori kerusakan* |
| 3 | - | - | *Tim Administrasi memilih satu tiket laporan* | - |
| 4 | - | - | - | *Sistem menampilkan rincian laporan: foto bukti, deskripsi keluhan, kategori, waktu masuk, peta lokasi, dan jumlah upvote* |
...
| 6 | - | - | - | *Admin memilih opsi pekerjaan selesai atau belum selesai* |
...
| 4 | - | - | - | *Sistem mengarahkan pelanggan ke halaman detail pekerjaan, hasil pekerjaan berupa foto/video, tanggal pekerjaan selesai, dan keterangan dapat dilihat* |
| 5 | - | - | *Admin mengonfirmasi hasil pekerjaan* | - |
| 6 | - | - | - | *Admin memilih opsi pekerjaan belum selesai* |
...
| 5 | - | - | *Admin meminta ulang foto/video pekerjaan* | - |
| 6 | - | - | - | *Admin memilih opsi kendala dan menuliskan keterangan dari kesalahn foto dan video* |
