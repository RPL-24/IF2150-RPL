...
| *KF13* | *R23* | *Ketika user membatalkan untuk mengikuti sesi, user tersebut dihapus dari database pendaftar sesi tersebut* |
| *KF14* | *R23* | *Ketika user menghapus sesi tersebut, system mengupdate database sesi untuk mengakomodasi penghapusan sesi tersebut* |
| *KF15* | *R24* | *Ketika user mengupdate data sesi tersebut, system mengupdate database sesi untuk mengakomodasi revisi data sesi tersebut agar tampilan sesuai* |
