...
| *F* | *Menambahkan US21, A13, R23, KF15, KF16, US22, A14, R24, KF17 untuk mengakomodasi fitur pembatalan sesi dan revisi data sesi* |
...
| *KF15* | *R23* | *Ketika user membatalkan untuk mengikuti sesi, user tersebut dihapus dari database pendaftar sesi tersebut* |
| *KF16* | *R23* | *Ketika user menghapus sesi tersebut, system mengupdate database sesi untuk mengakomodasi penghapusan sesi tersebut* |
| *KF17* | *R24* | *Ketika user mengupdate data sesi tersebut, system mengupdate database sesi untuk mengakomodasi revisi data sesi tersebut agar tampilan sesuai* |
...
| *UC10* | *Membatalkan Mengikuti Sesi* | *Mentee dapat membatalkan untuk mengikuti sesi yang sudah terdaftar olehnya* | *Mentee* | *KF15* |
| *UC11* | *Menghapus Sesi* | *Mentor dapat menghapus sesi yang sudah dibuat sebelumnya* | *Mentor* | *KF16* |
| *UC12* | *Mengedit Sesi* | *Mentor dapat mengedit sesi yang sudah dibuat sebelumnya untuk mengupdate data* | *Mentor* | *KF17* |
...
| No | Aksi Aktor | Reaksi Perangkat Lunak |
| :--- | :--- | :--- |
| 1 | *Pengguna membuka detail sesi yang ia telah daftar namun belum dimulai* | *Sistem menampilkan detail informasi sesi tersebut beserta tombol "Batal Keikutsertaan"* |
| 2 | *Pengguna menekan tombol "Batal Keikutsertaan"* | *Sistem menampilkan pop-up konfirmasi pembatalan* |
| 3 | *Pengguna mengonfirmasi pembatalan dengan menekan "Ya, Batalkan"* | *Sistem menghapus data mentee tersebut dari database pendaftar sesi dan pop-up "Berhasil Membatalkan Keikutsertaan" muncul* |
...
| 1 | *Pengguna membuka detail sesi yang ia telah daftar namun belum dimulai* | *Sistem menampilkan detail informasi sesi tersebut beserta tombol "Batal Keikutsertaan"* |
| 2 | *Pengguna menekan tombol "Batal Keikutsertaan"* | *Sistem menampilkan pop-up konfirmasi pembatalan* |
| 3 | *Pengguna menekan tombol "Kembali"* | *Sistem menutup pop-up dan tidak melakukan perubahan pada database* |
...
| No | Aksi Aktor | Reaksi Perangkat Lunak |
| :--- | :--- | :--- |
| 1 | *Pengguna membuka detail sesi yang ia telah membuat* | *Sistem menampilkan detail informasi sesi tersebut beserta tombol "Hapus Sesi"* |
| 2 | *Pengguna menekan tombol "Hapus Sesi"* | *Sistem menampilkan pop-up konfirmasi pembatalan* |
| 3 | *Pengguna mengonfirmasi penghapusan sesi dengan menekan tombol "Ya, Hapus"* | *Sistem menghapus dan menonaktifkan sesi tersebut, muncul pop-up "Sesi Berhasil Dihapus"* |
...
| 1 | *Pengguna membuka detail sesi yang ia telah membuat* | *Sistem menampilkan detail informasi sesi tersebut beserta tombol "Hapus Sesi"* |
| 2 | *Pengguna menekan tombol "Hapus Sesi"* | *Sistem menampilkan pop-up konfirmasi pembatalan* |
| 3 | *Pengguna menekan tombol "Batal"* | *Sistem menutup pop-up dan tidak terjadi perubahan pada database* |
...
| No | Aksi Aktor | Reaksi Perangkat Lunak |
| :--- | :--- | :--- |
| 1 | *Pengguna membuka detail sesi yang ia telah membuat* | *Sistem menampilkan detail informasi sesi tersebut beserta tombol "Edit Sesi"* |
| 2 | *Pengguna menekan tombol "Edit Sesi"* | *Sistem menampilkan formulir yang sudah terisi dengan data sesi saat ini (topik, jadwal, batas peserta, dan lain-lain) serta tombol "Simpan Perubahan"* |
| 3 | *Pengguna melakukan pengeditan terhadap formulir yang ditampilkan dan konfirmasi perubahan* | *Sistem mengupdate database dengan data yang telah direvisi agar tampilan sesuai, lalu memunculkan pop-up "Data sesi berhasil diperbarui"* |
...
| 1 | *Pengguna membuka detail sesi yang ia telah membuat* | *Sistem menampilkan detail informasi sesi tersebut beserta tombol "Edit Sesi"* |
| 2 | *Pengguna menekan tombol "Edit Sesi"* | *Sistem menampilkan formulir yang sudah terisi dengan data sesi saat ini (topik, jadwal, batas peserta, dan lain-lain) serta tombol "Simpan Perubahan"* |
| 3 | *Pengguna melakukan pengeditan terhadap jadwal ke waktu yang bertabrakan dengan sesi miliknya yang lain dan konfirmasi perubahan* | *Sistem mendeteksi ada tabrakan jadwal dan menampilkan notifikasi peringatan* |
| 4 | *Pengguna menyesuaikan kembali jadwalnya ke waktu yang sesuai dan konfirmasi perubahan* | *Sistem mengupdate database dengan data yang telah direvisi agar tampilan sesuai, lalu memunculkan pop-up "Data sesi berhasil diperbarui"* |

<br>

**Skenario Alternatif 2: Mentor Revisi Batas Peserta Lebih Kecil dari Batas Saat Ini**
 
| No | Aksi Aktor | Reaksi Perangkat Lunak |
| :--- | :--- | :--- |
| 1 | *Pengguna membuka detail sesi yang ia telah membuat* | *Sistem menampilkan detail informasi sesi tersebut beserta tombol "Edit Sesi"* |
| 2 | *Pengguna menekan tombol "Edit Sesi"* | *Sistem menampilkan formulir yang sudah terisi dengan data sesi saat ini (topik, jadwal, batas peserta, dan lain-lain) serta tombol "Simpan Perubahan"* |
| 3 | *Pengguna melakukan pengeditan terhadap batas peserta menjadi lebih kecil dari batas saat ini dan konfirmasi perubahan* | *Sistem mendeteksi bahwa batas tidak valid dan menampilkan notifikasi peringatan* |
| 4 | *Pengguna menyesuaikan kembali batas pesertanya dan konfirmasi perubahan* | *Sistem mengupdate database dengan data yang telah direvisi agar tampilan sesuai, lalu memunculkan pop-up "Data sesi berhasil diperbarui"* |