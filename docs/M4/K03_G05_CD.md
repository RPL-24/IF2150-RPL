...
| C16 | LaporanAkunPage | - | buatFormLaporan() submitLaporan() |
| C34 | LaporanController | - | prosesLaporan() |
| C41 | Mitra Pengacara | idMitra | getProfil() lihatUlasan() |
...
| ID Kelas | Nama Kelas | Atribut | Metode/Operasi |
| :--- | :--- | :--- | :--- |
| C18 | TinjauanPage | - | submitHasil() tampilkanLaporan() |
| C35 | ModerasiAkunController | - | prosesTinjauan() blokirAkun() updateStatusLaporan()|
| C42 | Admin | - | login() |
| C48 | Laporan | - | getDetailLaporan() |
...
| ID Kelas | Nama Kelas | Atribut | Metode/Operasi |
| :--- | :--- | :--- | :--- |
| C19 | HistoryPage | listRiwayat | lihatHistory() |
...
| ID Kelas | Nama Kelas | Atribut | Metode/Operasi |
| :--- | :--- | :--- | :--- |
| C21 | LiveChatAdminPage | | showAdminChatDashboard() markAsResolved() | 
| C37 | LiveChatController |  | assignAdmin() startChat() closeChat() |
| C42 | Admin | idAdmin, nama | balasPesan() |
| C50 | LiveChat | idChat, waktuChatMulai, waktuChatSelesai, statusChat, historyChat | updateStatusChat() detailChat() |
