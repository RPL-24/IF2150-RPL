...
| US-21 | _Mentee_/_Tutor_ | _Saya ingin membatalkan sesi_                                               | _sehingga saya bisa mengosongkan jadwal tersebut ketika berhalangan hadir_            
| US-22 | _Tutor_ | _Saya ingin mengedit data pada sesi yang kubuat_                                               | _sehingga saya bisa mengupdate sesi tersebut jika ada kendala atau perubahan_              
...
| A13 | Membatalkan Sesi                               | User membatalkan sesi yang diikuti atau sesi yang dibuat                                                 | US-21                   |
| A14 | Mengupdate Sesi                               | User mengupdate data sesi yang dibuat seperti waktu pelaksanaan, materi, dan lain-lain                                              | US-22                  |
...
| R23 | A13 | User | User dapat membatalkan untuk mengikuti sesi atau menghapus sesi yang dibuat | Ya |
| R24 | A14 | User | User dapat mengupdate data sesi yang dibuat sebagai Tutor | Ya |
